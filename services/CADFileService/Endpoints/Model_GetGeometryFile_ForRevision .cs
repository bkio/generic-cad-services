...
{
    internal class Model_GetGeometryFile_ForRevision : WebServiceBaseTimeoutableDeliveryEnsurerUser
    {
        ...
        public Model_GetGeometryFile_ForRevision(IBFileServiceInterface _FileService, IBDatabaseServiceInterface _DatabaseService, string _RestfulUrlParameter_ModelsKey, string _RestfulUrlParameter_RevisionsKey, string _CadFileStorageBucketName)
        {
        ...
        private BWebServiceResponse OnRequest_Internal(HttpListenerContext _Context, Action<string> _ErrorMessageAction)
        {
            ...
            {
                _ErrorMessageAction?.Invoke("Model_GetGeometryFile_ForRevision: GET method is accepted. But received request method:  " + _Context.Request.HttpMethod);
