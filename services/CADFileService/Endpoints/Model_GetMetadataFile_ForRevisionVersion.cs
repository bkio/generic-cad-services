...
{
    internal class Model_GetMetadataFile_ForRevisionVersion : WebServiceBaseTimeoutableDeliveryEnsurerUser
    {
        ...
        public Model_GetMetadataFile_ForRevisionVersion(IBFileServiceInterface _FileService, IBDatabaseServiceInterface _DatabaseService, string _RestfulUrlParameter_ModelsKey, string _RestfulUrlParameter_RevisionsKey, string _RestfulUrlParameter_VersionsKey, string _CadFileStorageBucketName)
        {
        ...
        private BWebServiceResponse OnRequest_Internal(HttpListenerContext _Context, Action<string> _ErrorMessageAction)
        {
            ...
            {
                _ErrorMessageAction?.Invoke("Model_GetMetadataFile_ForRevisionVersion: GET method is accepted. But received request method:  " + _Context.Request.HttpMethod);
